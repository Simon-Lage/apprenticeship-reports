...
export default function OnboardingProgress({
  ...
  return (
    <div className="space-y-3 rounded-xl border border-primary-tint bg-white p-4">
      ...
      <div className="pb-1">
        <ol className="grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-6">
          {stepOrder.map((stepId, index) => {
            ...
            if (isPending) {
              ...
              disabledReason = t('common.disabledReasons.stepNotSelectable');
            }
            ...
            const stepButton = (
              <button
                ...
                className={cn(
                  'group flex h-full w-full items-center gap-2 rounded-lg border px-3 py-2 text-left transition disabled:cursor-not-allowed',
                  isActive
                    ? 'border-primary bg-primary text-primary-contrast'
                    : 'border-primary-tint bg-white text-text-color',
                  isSelectable && !isActive
                    ? 'cursor-pointer hover:border-primary-shade hover:bg-primary-tint/25'
                    : '',
                ...
                {disabledReason ? (
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="block w-full">{stepButton}</span>
                    </TooltipTrigger>
