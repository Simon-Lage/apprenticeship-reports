...
export default function AppTopbar() {
  ...
  function isActivePath(path: string): boolean {
    ...
    if (path === appRoutes.weeklyReport) {
      return (
        location.pathname === appRoutes.weeklyReport ||
        location.pathname === appRoutes.weeklyReportPdf ||
        location.pathname === appRoutes.sendWeeklyReport ||
        location.pathname.startsWith(`${appRoutes.weeklyReport}/`)
      );
    }
