...
const appApi: AppApi = {
  ...
  changePassword: (input) => ipcRenderer.invoke(AppIpcChannel.changePassword, input),
  ...
  clearGoogleSession: () => ipcRenderer.invoke(AppIpcChannel.clearGoogleSession),
  setDriveScopes: (input) => ipcRenderer.invoke(AppIpcChannel.setDriveScopes, input),
  grantDriveScopes: (input) => ipcRenderer.invoke(AppIpcChannel.grantDriveScopes, input),
  connectGoogleDrive: () => ipcRenderer.invoke(AppIpcChannel.connectGoogleDrive),
  uploadBackupToDrive: () => ipcRenderer.invoke(AppIpcChannel.uploadBackupToDrive),
  ...
  requestManualBackup: () => ipcRenderer.invoke(AppIpcChannel.requestManualBackup),
  recordDailyReport: () => ipcRenderer.invoke(AppIpcChannel.recordDailyReport),
  registerBackupSuccess: () => ipcRenderer.invoke(AppIpcChannel.registerBackupSuccess),
  ...
  exportBackupArchive: () => ipcRenderer.invoke(AppIpcChannel.exportBackupArchive),
  prepareBackupImport: (serialized) =>
    ipcRenderer.invoke(AppIpcChannel.prepareBackupImport, serialized),
  cancelBackupImport: () => ipcRenderer.invoke(AppIpcChannel.cancelBackupImport),
